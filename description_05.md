...
> [!IMPORTANT]
> При удалении индикатора устройства происходит сдвиг (уменьшение значения id на 1) всего списка индикаторов,
> следовавших за удалённым, что не приводит к сбоям в работе системы.
