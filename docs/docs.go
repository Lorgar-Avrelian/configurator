    ...
    "paths": {
        ...
        "/api/v1/configurations/bind": {
            "post": {
                ...
                "tags": [
                    "14. Конфигурация: Привязка порога к рабочей конфигурации"
                ],
        ...
        "/api/v1/default-configurations/bind": {
            "post": {
                ...
                "tags": [
                    "13. Конфигурация: Привязка порога к конфигурации по умолчанию"
                ],
        ...
        "/api/v1/save-result": {
            "post": {
                ...
                "tags": [
                    "15. Результат: Экспортировать БД в SQL скрипт"
                ],
    ...
    "definitions": {
        ...
        "configurator_internal_dto.DeviceIndicatorUpdate": {
            ...
            "properties": {
                "contact": {
                    "type": "string",
                    "example": "sysadmin_new@company.com"
                },
                "description": {
                    "type": "string",
                    "example": "Updated Hardware info"
                },
                "location": {
                    "type": "string",
                    "example": "Server Room, Rack 4"
                },
                "name": {
                    "type": "string",
                    "example": "Core-Switch-01-Updated"
                },
                "object_id": {
                    "type": "string",
                    "example": "1.3.6.1.4.1.9.1.516"
