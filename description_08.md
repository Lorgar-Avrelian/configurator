...
> [!TIP]
> API предназначен для упорядочивания перечня составных частей и имеет одно ограничение: id вложенной составной части
> следовать строго после (быть больше) id родительской составной части.
...
```http
PATCH https://nms-dev.opk-bulat.ru/api/v1/catalog/device-component/9/10
...
```http
GET https://nms-dev.opk-bulat.ru/api/v1/catalog/device-components
